...
#ifndef SEARCHDAUMBLOG_SWIFT_H
#define SEARCHDAUMBLOG_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SearchDaumBlog",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14SearchDaumBlog11AppDelegate")
...
SWIFT_CLASS("_TtC14SearchDaumBlog12BlogListCell")
...
SWIFT_CLASS("_TtC14SearchDaumBlog12BlogListView")
@interface BlogListView : UITableView
- (nonnull instancetype)initWithFrame:(CGRect)frame style:(UITableViewStyle)style OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC14SearchDaumBlog10FilterView")
@interface FilterView : UITableViewHeaderFooterView
...
SWIFT_CLASS("_TtC14SearchDaumBlog18MainViewController")
...
SWIFT_CLASS("_TtC14SearchDaumBlog13SceneDelegate")
...
SWIFT_CLASS("_TtC14SearchDaumBlog9SearchBar")
