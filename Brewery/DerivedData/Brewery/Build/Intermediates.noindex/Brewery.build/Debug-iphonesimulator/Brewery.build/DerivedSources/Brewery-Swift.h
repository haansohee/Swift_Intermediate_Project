...
#ifndef BREWERY_SWIFT_H
#define BREWERY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Brewery",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Brewery11AppDelegate")
...
SWIFT_CLASS("_TtC7Brewery24BeerDetailViewController")
...
@interface BeerDetailViewController (SWIFT_EXTENSION(Brewery))
...
SWIFT_CLASS("_TtC7Brewery12BeerListCell")
...
SWIFT_CLASS("_TtC7Brewery22BeerListViewController")
@interface BeerListViewController : UITableViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithStyle:(UITableViewStyle)style OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
@interface BeerListViewController (SWIFT_EXTENSION(Brewery)) <UITableViewDataSourcePrefetching>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC7Brewery13SceneDelegate")
