...
#ifndef GITHUBAPP_SWIFT_H
#define GITHUBAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GitHubApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9GitHubApp11AppDelegate")
...
SWIFT_CLASS("_TtC9GitHubApp18RepositoryListCell")
@interface RepositoryListCell : UITableViewCell
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC9GitHubApp28RepositoryListViewController")
...
SWIFT_CLASS("_TtC9GitHubApp13SceneDelegate")
