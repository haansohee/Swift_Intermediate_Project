...
final class ProfileViewController: UIViewController {
    ...
    private let photoDataView = ProfileDataView(title: "게시물", count: 63)
    private let followerDataView = ProfileDataView(title: "팔로워", count: 937)
    private let followingDataView = ProfileDataView(title: "팔로잉", count: 247)
